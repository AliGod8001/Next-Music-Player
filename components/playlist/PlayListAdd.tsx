...
import { Avatar, ColorPicker, Form, Input, Modal } from 'antd'
...
const PlayListAdd = ({
    ...
    const { image, reset, status, output } = useImage({
    ...
    return <div className={styles['playlist-add']}>
        <MainButton type='primary-outline' onClick={showModal}>Add new playList</MainButton>
        ...
        <Modal title="Add PlayList" 
            ...
            onCancel={hideModal}
        >
            <Form form={formApi} name='add-playlist' onFinish={addPlayListFormFinishHandler} className={styles.form} tabIndex={1}>
                <Form.Item 
                    name="playlistTitle" 
                ...
                <div className={styles.avatar}>
                    <label htmlFor="playlistAvatar" className={`${styles.label} ${status === 501 ? styles['has-error'] : ""}`}>PlayList Avatar:</label>
