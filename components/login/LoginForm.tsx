        ...
        <div className={styles.wrapper}>
            <Form
                ...
                <Form.Item
                    name="email"
                    {...emailConfig}>
                    <Input type='email' prefix={<Icon icon='user' />} placeholder="email" />
                </Form.Item>
...

                {
                    !isLogin && (
                        <>
                            ...
                            {password && password.length > 3 && <PasswordStrength password={password} />}
                ...
                <Form.Item>
                    <MainButton type='primary' className={`${styles.button} ${loading ? "overlay-loading" : ""}`}>{isLogin ? "Login" : "Sign Up"}</MainButton>
                </Form.Item>
            </Form>
            {contextHolder}
        </div>
